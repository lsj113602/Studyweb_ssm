...
<html>
  <head>
   ...
   <meta http-equiv="pragma" content="no-cache">
    ...
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/js/article/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/js/article/ueditor.all.min.js"> </script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/js/article/lang/zh-cn/zh-cn.js"></script>
    <script src="${pageContext.request.contextPath}/js/baidu.js"></script>
    ...
    <!-- 
     ...
     -- -->
       <div style="height:60px"></div>
        ...
        <a href="<c:url value='article/FindArticleBycname?cname=${requestScope.cname}'/>"><button  class="btn btn-default btn-lg">取消</button></a>
